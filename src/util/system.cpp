...
const char * const BITCOIN_CONF_FILENAME = "newyorkcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NewYorkCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/NewYorkCoin";
#else
    // Unix-like
