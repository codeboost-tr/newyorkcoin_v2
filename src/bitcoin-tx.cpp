...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nyc-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nyc-tx [options] <hex-tx> [commands]  Update hex-encoded newyorkcoin transaction\n" +
            "or:     nyc-tx [options] -create [commands]   Create hex-encoded newyorkcoin transaction\n" +
            "\n";
